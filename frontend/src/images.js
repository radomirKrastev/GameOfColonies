...
const forestTiles = Array(4).fill(`https://images.unsplash.com/photo-1530799750-13f7b374d113?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=${width}&q=${height}`);
const sheepTiles = Array(4).fill(`https://images.unsplash.com/photo-1530483669142-1c576f37c37b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=${width}&q=${height}`);
const stoneTiles = Array(3).fill(`https://images.unsplash.com/photo-1599389932245-f414c9576ab4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=${width}&q=${height}`);
...
const dezertTile = [`https://images.unsplash.com/photo-1535093838480-90f893310529?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=${width}&q=${height}`];
